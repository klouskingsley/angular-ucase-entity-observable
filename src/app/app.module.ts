...
import { OnpushStrategyComponent } from './onpush-strategy/onpush-strategy.component'
...
@NgModule({
  ...
  declarations: [ AppComponent, CommentComponent, DefaultStrategyComponent, OnpushStrategyComponent ],
